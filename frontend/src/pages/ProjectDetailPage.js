...
const projectsData = {
  'corporate-office-acoustic': {
    ...
    heroImage: '/assets/images/project-office-hero.jpg',
    gallery: [
      '/assets/images/gallery-office-1.jpg',
      '/assets/images/gallery-office-2.jpg',
    ],
  ...
  'luxury-hotel-wet-area': {
    ...
    heroImage: '/assets/images/project-hotel-hero.jpg',
    gallery: [
      '/assets/images/gallery-hotel-1.jpg',
      '/assets/images/gallery-hotel-2.jpg',
    ],
  ...
  'hospital-fire-rated': {
    ...
    heroImage: '/assets/images/project-hospital-hero.jpg',
    gallery: [
      '/assets/images/gallery-hospital-1.jpg',
      '/assets/images/gallery-hospital-2.jpg',
    ],
  ...
  'villa-exterior-cladding': {
    ...
    heroImage: '/assets/images/project-villa-hero.jpg',
    gallery: [
      '/assets/images/gallery-villa-1.jpg',
      '/assets/images/gallery-villa-2.jpg',
    ],
  ...
  'airport-ceiling-corridor': {
    ...
    gallery: [
      '/assets/images/gallery-airport-1.jpg',
      '/assets/images/gallery-airport-2.jpg',
    ],
  ...
  'prefab-resort-lgsf': {
    ...
    heroImage: '/assets/images/project-resort-hero.jpg',
    gallery: [
      '/assets/images/gallery-resort-1.jpg',
      '/assets/images/gallery-resort-2.jpg',
    ],
